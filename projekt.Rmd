...
```{r zemljevid1, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Zemljevid števila igralcev iz posamezne države'}
...
```{r zemljevid2, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Zemljevid povprečja točk'}
