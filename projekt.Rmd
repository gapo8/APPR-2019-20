...
```{r histogram, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf 10 držav z največ igralci v NBA'}
...
```{r histogram, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Primerjava števila ameriških in ostalih igralcev'}
pie(stevilo[-1], labels = ime[-1], main = 'Število ameriških proti ostalim igralcem')
```

```{r histogram, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf povprečja točk na državo'}
...
```{r zemljevid, echo=FALSE, fig.align='center', fig.cap='Zemljevid števila igralcev iz posamezne države'}
...
```{r zemljevid, echo=FALSE, fig.align='center', fig.cap='Zemljevid povprečja točk'}
